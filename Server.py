        ...
        while True : 
            ...
            if buf:
                ...
                if(image_ext.decode()=="jpg"):
                    cv2.imwrite(r"C:\Users\DELL\OneDrive\Pictures\Screenshots\result.jpg", img_decode)
                    # open method used to open different extension image file
                    #im = Image.open(r"C:/Users/hanis/Desktop/result.jpg") 
                    # This method will show image in any image viewer 
                    #im.show() 
                elif(image_ext.decode()=="jpeg"):
                    cv2.imwrite(r"C:\Users\DELL\OneDrive\Pictures\Screenshots\result.jpeg", img_decode)
                    #im = Image.open(r"C:/Users/hanis/Desktop/result.jpeg") 
                    # This method will show image in any image viewer 
                    #im.show()
                else:
                    cv2.imwrite(r"C:\Users\DELL\OneDrive\Pictures\Screenshots\result.png", img_decode)
